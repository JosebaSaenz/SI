...
public class DialogAukeraBatEginBeharDa extends JDialog {
	...
	public DialogAukeraBatEginBeharDa() {
		getContentPane().setBackground(Color.DARK_GRAY);
		setTitle("Arazoa gertatu da");
		setIconImage(Toolkit.getDefaultToolkit().getImage(DialogAukeraBatEginBeharDa.class.getResource("/Fitxategiak/dialog_icon.png")));
		this.setModal(true);
		...
		jLabel1.setText("Iragazte teknika bat aukeratu behar da.");
